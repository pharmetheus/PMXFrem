test_that("setupDfCovsEV works", {
  ...
  expect_snapshot_value(stabilize(setupDfCovsEV(modFile,additionalCovs = "FORM")), style = "serialize")
  expect_snapshot_value(stabilize(setupDfCovsEV(modFile,fremCovs = c("AGE","SEX"),additionalCovs = "FORM")), style = "serialize")
})
