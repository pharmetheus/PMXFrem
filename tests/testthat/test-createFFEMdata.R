test_that("createFFEM works", {
  ...
  expect_snapshot(stabilize(as.data.frame(head(vpcData$newData, 20))))
  ...
  expect_snapshot(stabilize(as.data.frame(head(vpcData2$newData, 20))))
  ...
  expect_snapshot(stabilize(as.data.frame(head(vpcData3$newData, 20))))
})
