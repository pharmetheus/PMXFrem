...
paramFunctionExpVar <- function(basethetas, covthetas, dfrow, etas, ...) {
  ...
  FRELFOOD <- 1
  if (any(names(dfrow) == "FOOD") && dfrow$FOOD != missVal && dfrow$FOOD == 0) {
