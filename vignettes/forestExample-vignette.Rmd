...
```{r}
strRunDir <- "../inst/extdata/"            # The directory where the FREM model is located
strRunno  <- "run7"                        # The FREM model used to produce the forest plot

extFile <- paste0(strRunDir,strRunno,".ext") # The full path to the ext file
modFile <- paste0(strRunDir,strRunno,".mod") # The full path to the mod file
covFile <- paste0(strRunDir,strRunno,".cov") # The full path to the cov file
```
