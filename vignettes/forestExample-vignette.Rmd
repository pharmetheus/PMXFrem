...
runno <-"run31"
extFile <- system.file("extdata/SimNeb", paste0(runno,".ext"), package = "PMXFrem")
modFile <- system.file("extdata/SimNeb", paste0(runno,".mod"), package = "PMXFrem")
covFile <- system.file("extdata/SimNeb", paste0(runno,".cov"), package = "PMXFrem")
```
