...
Collect the file names related to the FREM run we are visualizing the results from. The utility function `getFileNames` returns a lis of file paths for the `.mod`, `.ext`, `.lst`, `.phi` and `.cov` files.
```{r} 
...
PMXForest::forestPlot(dfres,groupNameLabels = c("WT & LBWT","WT","BSA","LBWT","Reference"))
```
...
PMXForest::forestPlot(dfres4,groupNameLabels = covariates)
