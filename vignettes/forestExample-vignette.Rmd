...
dfParameters<-as.data.frame(FREMfunctions::mvrnorm_vector(mu=mu,sigma = sigma,iSampleIndex = 1000)) #Draw 1000 samples for cov matrix
...
functionList=list(function(thetas,coveffects,...){return(thetas[1]*exp(coveffects[1]))}, 
                                     function(thetas,coveffects,...){return(thetas[2]*exp(coveffects[2]))})
